...
/**
 * HiDebug 为开发者提供了调试应用程序的一些辅助方法
 *
 * HiDebug 对 FirePHP 这个 Firefox 插件提供了支持。
 * FirePHP 可以在运行时很方便的输出调试信息到浏览器的信息窗口。
 *
 * 要启用 HiDebug 对 FirePHP 的支持，调用 HiDebug::enableFirePHP() 即可。
 *
 */
