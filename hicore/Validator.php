 ...
 * 定义 Validator 类
  ...
  /**
 * Validator 提供了一组验证方法，以及调用验证方法的接口
 */
abstract class Validator {
     ...
     *
     * $validation 参数是验证规则。
     * 如果使用 Validator 自带的验证规则，可以使用如下的写法：
     *
     * @code php
     * Validator::validate($value, V('between', 1, 5));
     * @endcode
     *
     * 'between' 是验证规则的名字，对应于 Validator::validate_between() 方法。
     * 因此要使用 Validator 的其他验证方法，将方法名中的“validate_”去掉即为验证规则名。
     *
     * 如果要使用自定义的验证规则，有三种写法：
     *
     * @code php
